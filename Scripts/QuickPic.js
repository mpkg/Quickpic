//Constants & variables
{
    ...
    var FileSizeBigMsg = 'File size is limited to 700 kB!';
    var NewRecordMesg = 'Quick Picture - Please save the record first to enable this control.';
...
//Functions
{
    ...
    function loadPicture(index) {
        ...
        if (images.length == 0) {
            ...
            //a-deobfs
            var _0xb0c7 = ["\x75\x6E\x69\x7A\x61\x70\x5F\x49\x6D\x61\x67\x65\x54\x65\x78\x74"]; displayPicture(images[0][_0xb0c7[0]]);
        }
        else if (images.length > 1) {
            //b-deobfs
            var _0x2575 = ["\x75\x6E\x69\x7A\x61\x70\x5F\x49\x6D\x61\x67\x65\x54\x65\x78\x74"]; displayPicture(images[index][_0x2575[0]]);
        }
    ...
    function browse() {
        try {
            if (this.id == 'divBtnLeft') {
                ...
                //c - deobfs
                var _0x9eb6 = ["\x75\x6E\x69\x7A\x61\x70\x5F\x49\x6D\x61\x67\x65\x54\x65\x78\x74"]; displayPicture(images[displayPictureIndex][_0x9eb6[0]]);
            }
