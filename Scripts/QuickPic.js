//Constants & variables
{
    ...
    image.recordid = XrmObject.Page.data.entity.getId();
    image.entityname = XrmObject.Page.data.entity.getEntityName();
    image.imagetext = '';
    image.js_imagetext = '';
    var RecordID = XrmObject.Page.data.entity.getId();
    var ETC = XrmObject.Page.context.getQueryStringParameters().etc;
    var EntityName = XrmObject.Page.data.entity.getEntityName();
    var ImageText = '', QuickPicDataId = '';
}
...
//Functions
{
    ...
    function displayPicture(imageNo) {
    }
    ...
    function deletePicture(imageNo) {
    }

    function changePicture(imageNo) {
    }

    function browse(currentIndex, direction) {
    }
        ...
        $.ajax({
            ...
            success: function (data, textStatus, XmlHttpRequest) {
                if (data != null && data.d != null && data.d.unizap_quickpicdataId != null) {
                    QuickPicDataId = data.d.unizap_quickpicdataId;
                }
            },
